...
🌐 [Личный кабинет](https://univer-three.vercel.app/)
...
- **Формирование успеваемости** — работа с успеваемостью студентов по дисциплинам и группам.
- **Управление работами** — оценивание работ, создание, редактирование и удаление заданий. 
